		...
		<div id="testimonials-carousel" class="testimonials__carousel testimonials-carousel glide">
			<div class="glide__track" data-glide-el="track">
				<ul class="glide__slides">
					<li class="testimonials-carousel__item glide__slide" data-index="1">
						...
						<span class="testimonials-carousel__author testimonials-carousel-author">
					...
					<li class="testimonials-carousel__item glide__slide" data-index="2">
						<picture class="testimonials-carousel__picture">
							<img src="src/images/testimonials/avatar.png" alt="" class="testimonials-carousel__image">
						</picture>
					...
					<li class="testimonials-carousel__item glide__slide" data-index="3">
						<picture class="testimonials-carousel__picture">
							<img src="src/images/testimonials/avatar.png" alt="" class="testimonials-carousel__image">
						</picture>
